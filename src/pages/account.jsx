...
import { googleLogin } from "@/utils/fetchdata";
...
export default function AccountSettings() {
  ...
  const handleLogout = () => setUser({ name: null, email: null, sub: null, picture: null });
          ...
          <section>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  type="text"
                  className="w-full bg-zinc-800 text-white border border-zinc-700 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-zinc-500 transition"
                  value={name}
        ...
        <section>
                        ...
                        <div className="space-y-4">
                            <div className="flex justify-between items-center bg-zinc-800 p-4 rounded-lg">
                                ...
                                {user?.sub ? (<button className="bg-zinc-700 text-white px-4 py-1.5 rounded-full text-sm hover:bg-zinc-600 transition">
                                    UnLink
