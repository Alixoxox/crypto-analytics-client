...
export default function dashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a] font-spaceGrotesk text-white">
      ...
      <h1 className="text-2xl text-gray-200 font-bold">Market Overview</h1>
      ...
      <div className="flex justify-between gap-4">
        ...
        <span className="text-purple-300 hover:text-purple-400 hover:underline hover:cursor-pointer">View more</span>
      </div>
      </div>
      <Risk/>
