...
export const UserProvider = ({ children }) => {
  ...
  return (
    <UserContext.Provider value={{user,setUser,TopMarketData, setTopMarketData,viewCoin, setviewCoin,marketreview,setmarketreview,btc,setbtc,gainCoins,setgainCoins, isOpen, setisOpen,trendingCoins,settrendingCoins }}>
      {children}
